...
// // Fade-up effect card (không fetch API trong đây)
// const FadeUpCard = ({
//     card,
//     index,
// }: {
//     card: { nameTour: string; imageTour: string[] };
//     index: number;
// }) => {
//     const cardRef = useRef<HTMLDivElement>(null);
//     const [isVisible, setIsVisible] = useState(false);
...
//     const { data } = useQuery({
//         queryKey: ["tourtopselling"],
//         queryFn: () => instanceClient.get("/tourtopselling"),
//     });

//     const cardData = data?.data?.tourtopselling || [];
