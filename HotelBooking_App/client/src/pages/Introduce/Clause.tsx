        ...
        <section id="refund-policy" className="bg-white shadow overflow-hidden rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <h3 className="text-xl font-semibold mt-8 mb-4">Đối với tour quốc tế:</h3>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">Trước 45 ngày</td>
                      <td className="px-6 py-4 whitespace-nowrap text-green-600 font-medium">Hoàn 90% tiền đặt cọc</td>
                      <td className="px-6 py-4">Phí hủy 10% (chi phí visa, đặt vé)</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">Từ 30-44 ngày</td>
                      <td className="px-6 py-4 whitespace-nowrap text-blue-600 font-medium">Hoàn 70% tiền đặt cọc</td>
                      <td className="px-6 py-4">Phí hủy 30% tiền đặt cọc</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">Từ 7-14 ngày</td>
                      <td className="px-6 py-4 whitespace-nowrap text-orange-600 font-medium">Hoàn 20% tiền đặt cọc</td>
                      <td className="px-6 py-4">Phí hủy 80% tiền đặt cọc</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 whitespace-nowrap">Dưới 7 ngày</td>
                      <td className="px-6 py-4 whitespace-nowrap text-red-600 font-medium">Không hoàn tiền</td>
                      <td className="px-6 py-4">Phí hủy 100% tiền đặt cọc</td>
                    </tr>
                  </tbody>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  <strong>Thay đổi người tham gia:</strong> Khách hàng có thể thay đổi người tham gia tour mà không mất phí, với điều kiện thông báo trước ít nhất 7 ngày đối với tour trong nước và 15 ngày đối với tour quốc tế.
                </li>
                <li>
