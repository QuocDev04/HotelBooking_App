                ...
                <Form.Item name="payment_method" rules={[{ required: true, message: "Vui lòng chọn phương thức thanh toán" }]}>
                  <div className="grid grid-cols-1 gap-4 mb-8">
                    <label className="relative cursor-pointer group">
                      ...
                      />
                      <div className="p-8 transition-all duration-300 bg-white border-2 border-gray-200 peer-checked:border-green-500 peer-checked:shadow-lg peer-checked:shadow-green-100 rounded-3xl hover:shadow-xl hover:border-green-300 group-hover:-translate-y-1">
                        <div className="space-y-4 text-center">
                          <div className="flex items-center justify-center w-16 h-16 mx-auto transition-transform duration-300 rounded-full shadow-lg bg-gradient-to-br from-green-400 to-emerald-500 peer-checked:scale-110">
                        ...
                        <div className="absolute flex items-center justify-center w-6 h-6 transition-all duration-200 border-2 border-gray-300 rounded-full top-6 right-6 peer-checked:border-green-500 peer-checked:bg-green-500">
                    ...
                    <label className="relative cursor-pointer group">
                      <input
                        ...
                        className="sr-only peer"
                      />
                      <div className="p-8 transition-all duration-300 bg-white border-2 border-gray-200 peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:shadow-blue-100 rounded-3xl hover:shadow-xl hover:border-blue-300 group-hover:-translate-y-1">
                        <div className="space-y-4 text-center">
                          <div className="flex items-center justify-center w-16 h-16 mx-auto transition-transform duration-300 rounded-full shadow-lg bg-gradient-to-br from-blue-400 to-indigo-500 peer-checked:scale-110">
                            <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                              <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4zM18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" />
                            </svg>
                          </div>
                        ...
                        <div className="absolute flex items-center justify-center w-6 h-6 transition-all duration-200 border-2 border-gray-300 rounded-full top-6 right-6 peer-checked:border-blue-500 peer-checked:bg-blue-500">
                          <svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                          </svg>
                        </div>
                    ...
                    <div className="space-y-4">
                      <label className="relative block cursor-pointer group">
                        <input
                          ...
                          className="sr-only peer"
                        />
                        <div className="p-6 transition-all duration-300 border-2 border-gray-200 bg-gradient-to-br from-orange-50 to-red-50 peer-checked:border-orange-500 peer-checked:bg-gradient-to-br peer-checked:from-orange-100 peer-checked:to-red-100 rounded-2xl hover:shadow-lg group-hover:border-orange-300">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex items-center justify-center w-6 h-6 transition-all duration-200 border-2 border-gray-300 rounded-full peer-checked:border-orange-500 peer-checked:bg-orange-500">
                              <svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                              </svg>
                            </div>
                      ...
                      <label className="relative block cursor-pointer group">
                        <input
                          ...
                          className="sr-only peer"
                        />
                        <div className="p-6 transition-all duration-300 border-2 border-gray-200 bg-gradient-to-br from-emerald-50 to-green-50 peer-checked:border-emerald-500 peer-checked:bg-gradient-to-br peer-checked:from-emerald-100 peer-checked:to-green-100 rounded-2xl hover:shadow-lg group-hover:border-emerald-300">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex items-center justify-center w-6 h-6 transition-all duration-200 border-2 border-gray-300 rounded-full peer-checked:border-emerald-500 peer-checked:bg-emerald-500">
                              <svg className="w-3 h-3 text-white opacity-0 peer-checked:opacity-100" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                              </svg>
                            </div>
