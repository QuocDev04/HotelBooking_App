...
const InfoUser = () => {
    ...
    const getCancellationFeePercent = (daysLeft: number, isPlaneTour: boolean): number => {
    if (isPlaneTour) {
        ...
        if (daysLeft > 10) return 0;
        if (daysLeft >= 5) return 20;
    ...
    const now = new Date();
    const daysBeforeDeparture = Math.ceil((tourDate.getTime() - now.getTime()) / (1000 * 60 * 60 * 24));

    const isCancelled = bill.payment_status === 'cancelled' || bill.payment_status === 'pending_cancel';
    const isPast = tourDate <= now;

    // Xác định loại tour
    const isPlaneTour = bill.slotId.tour.tourType === 'maybay'; // bạn cần dùng đúng key ở đây

    if (isCancelled || isPast) return false;

    // Áp dụng điều kiện hủy theo loại tour
    if (isPlaneTour && daysBeforeDeparture < 6) {
        return false; // máy bay: không hủy được nếu còn dưới 6 ngày
    }

    if (!isPlaneTour && daysBeforeDeparture < 2) {
        return false; // xe khách: không hủy được nếu còn dưới 2 ngày
    }
    ...
    const now = new Date();
    const daysBeforeDeparture = Math.ceil((tourDate.getTime() - now.getTime()) / (1000 * 60 * 60 * 24));
    const isPlaneTour = bill.slotId.tour.tourType === 'maybay';
    const feePercent = getCancellationFeePercent(daysBeforeDeparture, isPlaneTour);

    const confirmMessage = `
Tour của bạn còn ${daysBeforeDeparture} ngày nữa sẽ khởi hành.
Nếu bạn hủy bây giờ, chúng tôi sẽ khấu trừ ${feePercent}% tổng giá trị tour.
        ...
        <div className="min-h-screen">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div className="mb-12 text-center ">
                    <h1 className="my-20 mb-4 text-4xl font-bold text-gray-900">
                ...
                {filteredbookings.length === 0 ? (
                    <div className="py-12 text-center">
                        ...
                        <h3 className="mb-2 text-xl font-semibold text-gray-900">Chưa có đặt chỗ nào</h3>
                    ...
                    <div className="space-y-6">
                        {filteredbookings.map((bill: Bill, index: number) => (
                            <div key={bill._id || index} className="overflow-hidden transition-all duration-300 bg-white border border-gray-100 shadow-lg rounded-2xl hover:shadow-xl">
                                <div className="p-8">
                                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                                        <div className="flex-1 mb-6 lg:mb-0">
                                            <div className="flex items-start space-x-4">
                                                <div className="flex-shrink-0">
                                                    <div className="flex items-center justify-center w-20 h-20 overflow-hidden shadow-lg rounded-xl bg-gradient-to-br from-purple-400 to-pink-500">
                                        ...
                                        <div className="flex flex-col items-end space-y-4">
                                            ...
                                            <div className="flex space-x-3">
                                                <button
                                                    ...
                                                    className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 transition-colors duration-200 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                                >
                                                ...
                                                {bill.payment_status === 'pending' && (
                                                    <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-white transition-colors duration-200 bg-green-600 border border-transparent rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                {canCancelBooking(bill) && (
                                                    <button 
                                                        ...
                                                        className="inline-flex items-center px-4 py-2 text-sm font-medium text-white transition-colors duration-200 bg-red-600 border border-transparent rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                    >
                                                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/80 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-200">
                        ...
                        <div className="p-6">
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start space-x-6">
                                    <div className="flex-shrink-0">
                                        <div className="w-32 h-32 overflow-hidden shadow-lg bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl">
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div className="p-6 bg-gray-50 rounded-xl">
                                        <h4 className="mb-4 text-lg font-semibold text-gray-900">Thông tin tour</h4>
                                    ...
                                    <div className="p-6 bg-gray-50 rounded-xl">
                                        <h4 className="mb-4 text-lg font-semibold text-gray-900">Thông tin đặt chỗ</h4>
                                        <div className="space-y-3">
                                            <div className="flex justify-between">
                                ...
                                <div className="p-6 bg-gray-50 rounded-xl">
                                    <h4 className="mb-4 text-lg font-semibold text-gray-900">Thông tin hành khách</h4>
                                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                        {/* Adults */}
                                        {selectedBill.adultPassengers.length > 0 && (
                                            <div>
                                                <h5 className="mb-3 font-medium text-gray-900 text-md">Người lớn ({selectedBill.adultsTour})</h5>
                                                <div className="space-y-3">
                                        ...
                                        {selectedBill.childrenTour > 0 && (
                                            <div>
                                                <h5 className="mb-3 font-medium text-gray-900 text-md">Trẻ em ({selectedBill.childrenTour})</h5>
                                                <div className="space-y-3">
                                        ...
                                        {selectedBill.toddlerTour > 0 && (
                                            <div>
                                                <h5 className="mb-3 font-medium text-gray-900 text-md">Trẻ nhỏ ({selectedBill.toddlerTour})</h5>
                                                <div className="space-y-3">
                                        ...
                                        {selectedBill.infantTour > 0 && (
                                            <div>
                                                <h5 className="mb-3 font-medium text-gray-900 text-md">Em bé ({selectedBill.infantTour})</h5>
                                                <div className="space-y-3">
                                ...
                                {/* Payment Information */}
                                <div className="p-6 bg-gray-50 rounded-xl">
                                    <h4 className="mb-4 text-lg font-semibold text-gray-900">Thông tin thanh toán</h4>
                                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                        <div className="space-y-3">
                                            <div className="flex justify-between">
                        ...
                        <div className="flex items-center justify-end p-6 space-x-3 border-t border-gray-200">
                            <button
                                onClick={closeDetailModal}
                                className="px-4 py-2 text-gray-700 transition-colors duration-200 bg-gray-100 rounded-lg hover:bg-gray-200"
                            >
                                Đóng
                            </button>
                            {selectedBill?.payment_status === 'pending' && (
                                <button className="px-4 py-2 text-white transition-colors duration-200 bg-green-600 rounded-lg hover:bg-green-700">
                                    Thanh toán ngay
                                </button>
                            )}
                        </div>
            ...
            {showCancelModal && bookingToCancel && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="w-full max-w-md bg-white border border-gray-200 shadow-2xl rounded-2xl">
                        {/* Modal Header */}
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                        ...
                        <div className="flex items-center justify-end p-6 space-x-3 border-t border-gray-200">
                            ...
                            <button
                                ...
                                className="px-4 py-2 text-white transition-colors duration-200 bg-red-600 rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled={requestCancelMutation.isPending}
                            >
