...
>>>>>>> 6f2799cd82d68c2e2dd007db003c5de813d02bd1
                ...
                {/* User Profile Card */}
<<<<<<< HEAD
                <div className="p-10 mx-2 mb-16 bg-white border border-gray-100 shadow-xl rounded-2xl">
...
>>>>>>> 6f2799cd82d68c2e2dd007db003c5de813d02bd1
                        <div className="relative">
                            <img
                                ...
                                alt="avatar"
                                className="border-4 border-white rounded-full shadow-lg w-28 h-28"
                            />
                            <div className="absolute flex items-center justify-center w-8 h-8 bg-green-500 border-4 border-white rounded-full -bottom-2 -right-2">
                        ...
                        <div className="text-center md:text-left">
                            <h2 className="mb-2 text-2xl font-bold text-gray-900">{users?.username}</h2>
                ...
                {/* Stats Section */}
                <div className="grid grid-cols-1 gap-6 mx-2 mb-12 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                    {/* Tổng đặt chỗ */}
                    <div className="p-6 transition-all duration-300 transform border border-blue-200 shadow-lg group bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 rounded-2xl hover:shadow-xl hover:-translate-y-1">
                        <div className="flex items-center justify-between">
                            <div className="flex-1">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 text-white transition-transform duration-300 bg-blue-500 shadow-lg rounded-xl group-hover:scale-110">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                        </svg>
                                    </div>
                                </div>
                                <p className="mb-1 text-sm font-semibold text-blue-700">Tổng đặt chỗ</p>
                                <p className="text-3xl font-bold text-blue-900 transition-colors group-hover:text-blue-800">{totalBookings}</p>
                            </div>
                        </div>
                    </div>

                    {/* Đã thanh toán đủ */}
                    <div className="p-6 transition-all duration-300 transform border border-green-200 shadow-lg group bg-gradient-to-br from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 rounded-2xl hover:shadow-xl hover:-translate-y-1">
                        <div className="flex items-center justify-between">
                            <div className="flex-1">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 text-white transition-transform duration-300 bg-green-500 shadow-lg rounded-xl group-hover:scale-110">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                        </svg>
                                    </div>
                                </div>
                                <p className="mb-1 text-sm font-semibold text-green-700">Đã thanh toán</p>
                                <p className="text-3xl font-bold text-green-900 transition-colors group-hover:text-green-800">{paidBookings}</p>
                            </div>
                        </div>
                    </div>

                    {/* Đã đặt cọc */}
                    <div className="p-6 transition-all duration-300 transform border border-yellow-200 shadow-lg group bg-gradient-to-br from-yellow-50 to-yellow-100 hover:from-yellow-100 hover:to-yellow-200 rounded-2xl hover:shadow-xl hover:-translate-y-1">
                        <div className="flex items-center justify-between">
                            <div className="flex-1">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 text-white transition-transform duration-300 bg-yellow-500 shadow-lg rounded-xl group-hover:scale-110">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                                        </svg>
                                    </div>
                                </div>
                                <p className="mb-1 text-sm font-semibold text-yellow-700">Đã đặt cọc</p>
                                <p className="text-3xl font-bold text-yellow-900 transition-colors group-hover:text-yellow-800">{depositBookings}</p>
                            </div>
                        </div>
                    </div>

                    {/* Chờ thanh toán */}
                    <div className="p-6 transition-all duration-300 transform border border-orange-200 shadow-lg group bg-gradient-to-br from-orange-50 to-orange-100 hover:from-orange-100 hover:to-orange-200 rounded-2xl hover:shadow-xl hover:-translate-y-1">
                        <div className="flex items-center justify-between">
                            <div className="flex-1">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 text-white transition-transform duration-300 bg-orange-500 shadow-lg rounded-xl group-hover:scale-110">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </div>
                                </div>
                                <p className="mb-1 text-sm font-semibold text-orange-700">Chờ thanh toán</p>
                                <p className="text-3xl font-bold text-orange-900 transition-colors group-hover:text-orange-800">{pendingBookings}</p>
                            </div>
                        </div>
                    </div>

                    {/* Đã hủy */}
                    <div className="p-6 transition-all duration-300 transform border border-red-200 shadow-lg group bg-gradient-to-br from-red-50 to-red-100 hover:from-red-100 hover:to-red-200 rounded-2xl hover:shadow-xl hover:-translate-y-1">
                        <div className="flex items-center justify-between">
                            <div className="flex-1">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 text-white transition-transform duration-300 bg-red-500 shadow-lg rounded-xl group-hover:scale-110">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                    </div>
                                </div>
                                <p className="mb-1 text-sm font-semibold text-red-700">Đã hủy</p>
                                <p className="text-3xl font-bold text-red-900 transition-colors group-hover:text-red-800">{cancelledBookings}</p>
                            </div>
                        </div>
                    </div>

                    {/* Hoàn thành */}
                    <div className="p-6 transition-all duration-300 transform border border-purple-200 shadow-lg group bg-gradient-to-br from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 rounded-2xl hover:shadow-xl hover:-translate-y-1">
                        <div className="flex items-center justify-between">
                            <div className="flex-1">
                                <div className="flex items-center mb-3">
                                    <div className="p-3 text-white transition-transform duration-300 bg-purple-500 shadow-lg rounded-xl group-hover:scale-110">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </div>
                                </div>
                                <p className="mb-1 text-sm font-semibold text-purple-700">Hoàn thành</p>
                                <p className="text-3xl font-bold text-purple-900 transition-colors group-hover:text-purple-800">{completedBookings}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
>>>>>>> 6f2799cd82d68c2e2dd007db003c5de813d02bd1
            ...
            {showDetailModal && selectedBill && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-40 backdrop-blur-sm">
                    <div className="w-full max-w-4xl max-h-screen overflow-y-auto bg-white border border-gray-200 shadow-2xl rounded-2xl animate-pulse">
                        {/* Modal Header */}
...
>>>>>>> 6f2799cd82d68c2e2dd007db003c5de813d02bd1
                        ...
                        <div className="flex items-center justify-end p-6 space-x-3 border-t border-gray-200">
                            ...
                            {(selectedBill?.payment_status === 'deposit_paid' || (selectedBill?.isDeposit && !selectedBill?.isFullyPaid)) && (
                                <button
                                    ...
                                    className="px-4 py-2 text-white transition-colors duration-200 bg-indigo-500 rounded-lg hover:bg-indigo-600"
                                >
                                    Hoàn tất thanh toán
                                </button>
                            )}
            ...
            {showCancelModal && bookingToCancel && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-40 backdrop-blur-sm">
                    <div className="w-full max-w-lg max-h-screen overflow-y-auto bg-white border border-gray-200 shadow-2xl rounded-2xl animate-pulse">
                        {/* Header */}
                        ...
                        <div className="p-6">
                            ...
                            <div className="p-4 mb-6 border border-yellow-200 rounded-lg bg-yellow-50">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h4 className="mb-2 font-semibold text-yellow-800">Chính sách hoàn tiền</h4>
