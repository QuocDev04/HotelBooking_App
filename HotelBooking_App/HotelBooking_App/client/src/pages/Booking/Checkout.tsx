        ...
        Modal.success({
          ...
          content: (
            <div>
              ...
              <p className="text-red-500 mt-2">Lưu ý: Tour chỉ được xác nhận sau khi đã thanh toán đặt cọc</p>
            </div>
          ),
          onOk: () => {
            navigate(`/booking/${bookingId}`);
      ...
      >
        <div className="py-4">
          ...
          <div className="space-y-4">
            ...
            <div 
              className="bg-blue-50 p-4 rounded-lg border border-blue-200 mb-4 hover:bg-blue-100 cursor-pointer"
