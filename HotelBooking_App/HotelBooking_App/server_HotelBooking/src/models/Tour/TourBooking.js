...
const TourBookingSchema = new mongoose.Schema({
    ...
    // Đánh dấu phần còn lại sẽ thanh toán bằng tiền mặt
    cashPaymentRemaining: { type: Boolean, default: false },
    ...
    payment_status: {
        type: String,
        enum: ['pending', 'deposit_paid', 'completed', 'cancelled', 'pending_cancel'],
        default: 'pending',
    },
