...
const InfoUser = () => {
  ...
  switch (status) {
    case 'upcoming':
      return <span className="px-3 py-1 text-sm font-medium text-green-800 bg-green-100 rounded-full">Sắp diễn ra</span>;
    case 'ongoing':
      return <span className="px-3 py-1 text-sm font-medium text-blue-800 bg-blue-100 rounded-full">Đang diễn ra</span>;
    case 'completed':
      return <span className="px-3 py-1 text-sm font-medium text-red-800 bg-red-100 rounded-full">Đã hoàn thành</span>;
    default:
      return <span className="px-3 py-1 text-sm font-medium text-gray-800 bg-gray-100 rounded-full">Không xác định</span>;
  }
};
                                                ...
                                                <div className="flex flex-col space-y-6 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
                                                    ...
                                                    <div className="flex flex-col items-start space-y-4 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4">
                                                        ...
                                                        <div className="flex flex-wrap gap-2 space-x-2">
                                                            ...
                                                            {/* Hiển thị trạng thái tour từ TourStatusList */}
                                                            {getTourStatusTag(bill?.slotId?.status || '')}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
