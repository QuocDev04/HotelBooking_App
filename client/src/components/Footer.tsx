  ...
  return (
    ...
    <>
      <div className="relative">
        {/* Ảnh nền và lớp overlay màu xanh */}
        <div className="absolute inset-0">
          <img
            src="https://bizweb.dktcdn.net/100/489/447/themes/912592/assets/bg_footer.png?1743654439525"
            alt="Footer Background"
            className="w-full h-full object-cover bg-[#006CAA]"
          />
        </div>
          ...
          <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-md">
              <strong className="block text-center text-xl font-bold text-gray-900 sm:text-3xl dark:text-white">
                Đăng ký nhận thông tin tour mới nhất từ Elite Travel
              </strong>
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
              <div className="mx-auto max-w-sm lg:max-w-none">
                <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg dark:text-gray-400">
                  Elite Travel – chuyên tổ chức tour du lịch trong và ngoài nước, mang đến trải nghiệm du lịch đẳng cấp, an toàn và đáng nhớ cho mọi khách hàng.
                </p>
            ...
            <div className="mt-16 border-t border-gray-100 pt-8 dark:border-gray-800">
              <p className="text-center text-sm text-gray-300 lg:text-center dark:text-gray-400">
                © 2025 Elite Travel. Bản quyền đã được bảo hộ.
              </p>
            </div>
          </div>
        </footer>
