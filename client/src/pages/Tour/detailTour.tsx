...
const TourPage = () => {
  ...
  return (
    <>
      <div className="max-w-screen-xl p-4 mx-auto mt-32 font-sans">
        {/* Title */}
        ...
        <div className="grid grid-cols-1 gap-2 lg:grid-cols-3 lg:gap-8">
              ...
              <div className="grid max-w-4xl grid-cols-4 gap-4">
                {thumbnails.map((src, index) => (
                  <img
                    key={index}
                    src={src}
                    className="object-cover rounded-lg cursor-pointer thumb md:h-24 h-14 hover:opacity-80"
                    alt={`Thumb ${index + 1}`}
          ...
          <div className="max-w-[460px] w-full bg-blue-100/90 p-5 max-md:mt-16 border rounded-4xl border-gray-300/70">
            <h2 className="my-2 font-medium text-blue-500 lg:text-4xl md:text-xl">15.000.000đ</h2>
            ...
            <div className="my-6 space-y-2">
              <div className="flex items-center justify-between gap-4">
                ...
                {/* Nút tăng/giảm */}
                <div className="flex items-center border border-gray-200 rounded-xl dark:border-blue-600">
                  ...
                  <input
                    ...
                    value={adults}
                    readOnly
                    className="w-16 text-center border-transparent appearance-none h-9 sm:text-sm"
                  />
            ...
            <div className="flex items-center justify-between pt-4 text-lg font-bold text-blue-600 border-t">
              <span>Tổng tiền:</span>
